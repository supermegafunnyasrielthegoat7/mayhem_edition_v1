...
function onUpdate()
	...
	doTweenAlpha('AlphaTween3', 'scoreTxt', 0.1, 0.1)
	doTweenAlpha('AlphaTween4', 'iconP1', 0, 0.1) -- 1
	doTweenAlpha('AlphaTween5', 'iconP2', 0, 0.1) -- 1
	doTweenAlpha('AlphaTween6', 'timeBar', 0, 0.1)
	doTweenAlpha('AlphaTween7', 'timeBarBG', 0, 0.1)
	doTweenAlpha('AlphaTween8', 'timeTxt', 0, 0.1)
	doTweenAlpha('AlphaTween966556655656', 'songTxt', 0, 0.1)
	end
	...
	doTweenAlpha('AlphaTween4', 'iconP1', 0.55, 0.1); -- 2
	doTweenAlpha('AlphaTween5', 'iconP2', 0.55, 0.1) --2
	if getProperty('health') >= 0.8 then
	doTweenAlpha('AlphaTween4', 'iconP1', 0.55, 0.1); -- 2
	doTweenAlpha('AlphaTween5', 'iconP2', 0.55, 0.1) -- 2
	if mustHitSection == false then
	doTweenAlpha('AlphaTween2', 'healthBar', 0.1, 0.1)
	doTweenAlpha('AlphaTween4', 'iconP1', 0.55, 0.1)
	doTweenAlpha('AlphaTween5', 'iconP2', 0.55, 0.1)
	...
	doTweenAlpha('AlphaTween4', 'iconP1', 1, 0.1) -- 25
--	doTweenAlpha('AlphaTween5', 'iconP2', 0, 0.25)
	...
	doTweenAlpha('AlphaTween966556655656', 'songTxt', 1, 0.1)
