...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			[' M A Y H E M '],
			['milkbox_hitbox',		'retard',		'creator of the mod',					 '',		'FlxColor.fromRGB(255, 180, 73)'],
			['sonic_yd',		'stupistufas',		'SUPER DUPER swag guy (buzzy creator)',					 '',		'FlxColor.fromRGB(146, 75, 100)'],
			['buzzy',		'fatty',		'SCREW YOU | YOU GET NO MORE GAMES',					 '',		'FlxColor.fromRGB(206, 193, 93)'],
			[''],
			['Psych Engine Team'],
		...
		descText.setFormat(Paths.font("fakecomic.ttf"), 32, FlxColor.WHITE, CENTER/*, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK*/);
